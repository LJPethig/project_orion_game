...
### Quit behaviour
The player can only quit at a saveable moment. The quit option is not available
during timed actions or while any panel is open. When quit is selected, the game
saves both files then exits.
